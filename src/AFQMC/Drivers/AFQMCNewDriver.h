...
#ifndef SFQMC_AFQMC_AFQMCNEWDRIVER_H
#define SFQMC_AFQMC_AFQMCNEWDRIVER_H
...
namespace afqmc
{
class AFQMCNewDriver : public AFQMCInfo
{
public:
  AFQMCNewDriver(boost::mpi3::communicator& comm,
              AFQMCInfo& info,
              std::string& title,
              int mser,
              int blk0,

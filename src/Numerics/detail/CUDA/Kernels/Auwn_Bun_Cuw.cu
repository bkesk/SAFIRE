                                                 ...
                                                 int stride)
{
  ...
  if ((i < ni) && (j < nj) && (k < nk))
    C[k * stride + i * ldc + j] = A[i * lda + j] * B[j * ldb + k];
}
                                                 ...
                                                 int stride)
{
  ...
  if ((i < ni) && (j < nj) && (k < nk))
  {
    if (transA == 'N')
      ...
      C[k * stride + i * ldc + j] = conj(A[i * lda + j]) * B[j * ldb + k];
  }
}
                  ...
                  std::complex<double>* C)
{
  ...
  kernel_Auwn_Bun_Cuw<<<grid_dim, block_dim>>>(nu, nw, na, static_cast<thrust::complex<double> const>(alpha),
                  ...
                  std::complex<float>* C)
{
  ...
  dim3 grid_dim(nbks, 1, 1);
  dim3 block_dim(nthr, nw, 1);
  kernel_Auwn_Bun_Cuw<<<grid_dim, block_dim>>>(nu, nw, na, static_cast<thrust::complex<float> const>(alpha),
                  ...
                  int ldc)
{
  ...
  dim3 grid_dim(nbks, 1, 1);
  dim3 block_dim(nthr, nw, 1);
  kernel_Awiu_Biu_Cuw<<<grid_dim, block_dim>>>(nu, nw, na, static_cast<thrust::complex<double> const>(alpha),
                  ...
                  int ldc)
{
  ...
  dim3 grid_dim(nbks, 1, 1);
  dim3 block_dim(nthr, nw, 1);
  kernel_Awiu_Biu_Cuw<<<grid_dim, block_dim>>>(nu, nw, na, static_cast<thrust::complex<float> const>(alpha),
                  ...
                  int ldc)
{
  ...
  kernel_Aijk_Bkj_Cik<<<grid_dim, 32>>>(ni, nj, nk, reinterpret_cast<thrust::complex<double> const*>(A), lda, stride,
                                        reinterpret_cast<thrust::complex<double> const*>(B), ldb,
                                        reinterpret_cast<thrust::complex<double>*>(C), ldc);
  qmc_cuda::cuda_check(cudaGetLastError());
  qmc_cuda::cuda_check(cudaDeviceSynchronize());
                  ...
                  int ldc)
{
  // expect nk >> ni,nj
  dim3 grid_dim(nk, ni, 1);
  kernel_Aijk_Bkj_Cik<<<grid_dim, 32>>>(ni, nj, nk, reinterpret_cast<thrust::complex<double> const*>(A), lda, stride, B,
                                        ldb, reinterpret_cast<thrust::complex<double>*>(C), ldc);
  qmc_cuda::cuda_check(cudaGetLastError());
  qmc_cuda::cuda_check(cudaDeviceSynchronize());
}
                  ...
                  int ldc)
{
  // expect nk >> ni,nj
  dim3 grid_dim(nk, ni, 1);
  kernel_Aijk_Bkj_Cik<<<grid_dim, 32>>>(ni, nj, nk, reinterpret_cast<thrust::complex<float> const*>(A), lda, stride,
                                        reinterpret_cast<thrust::complex<float> const*>(B), ldb,
                                        reinterpret_cast<thrust::complex<float>*>(C), ldc);
  qmc_cuda::cuda_check(cudaGetLastError());
  qmc_cuda::cuda_check(cudaDeviceSynchronize());
                  ...
                  int ldc)
{
  // expect nk >> ni,nj
  dim3 grid_dim(nk, ni, 1);
  kernel_Aijk_Bkj_Cik<<<grid_dim, 32>>>(ni, nj, nk, reinterpret_cast<thrust::complex<float> const*>(A), lda, stride, B,
                                        ldb, reinterpret_cast<thrust::complex<float>*>(C), ldc);
  qmc_cuda::cuda_check(cudaGetLastError());
  qmc_cuda::cuda_check(cudaDeviceSynchronize());
}
...
void viwj_vwij(int nw, int ni, int i0, int iN, std::complex<double> const* B, std::complex<double>* A)
{
  ...
  kernel_viwj_vwij<<<grid_dim, MAX_THREADS_PER_DIM>>>(nw, ni, i0, iN,
                                                      reinterpret_cast<thrust::complex<double> const*>(B),
                               ...
                               int stride)
{
  ...
  kernel_element_wise_Aij_Bjk_Ckij<<<grid_dim, MAX_THREADS_PER_DIM>>>(transA, ni, nj, nk, A, lda,
                                                                      reinterpret_cast<thrust::complex<double> const*>(
                                                                          B),
                                                                      ldb,
                                                                      reinterpret_cast<thrust::complex<double>*>(C),
                                                                      ldc, stride);
                               ...
                               int stride)
{
  ...
  dim3 grid_dim(ni, nbks, nk);
  kernel_element_wise_Aij_Bjk_Ckij<<<grid_dim, MAX_THREADS_PER_DIM>>>(transA, ni, nj, nk, A, lda,
                                                                      reinterpret_cast<thrust::complex<float> const*>(
                                                                          B),
                                                                      ldb, reinterpret_cast<thrust::complex<float>*>(C),
                                                                      ldc, stride);
  qmc_cuda::cuda_check(cudaGetLastError());
  qmc_cuda::cuda_check(cudaDeviceSynchronize());
}
                               ...
                               int stride)
{
  ...
  kernel_element_wise_Aij_Bjk_Ckji<<<grid_dim, block_dim>>>(ni, nj, nk, A, lda,
                                                            reinterpret_cast<thrust::complex<double> const*>(B), ldb,
                               ...
                               int stride)
{
  ...
  dim3 grid_dim(jb, ib, nk);
  dim3 block_dim(nthr, nthrj, 1);
  kernel_element_wise_Aij_Bjk_Ckji<<<grid_dim, block_dim>>>(ni, nj, nk,

...
// Level-1
inline cublasStatus_t cublas_copy(cublasHandle_t handle, int n, float const* x, int incx, float* y, int incy)
{
...
inline cublasStatus_t cublas_copy(cublasHandle_t handle, int n, double const* x, int incx, double* y, int incy)
{
                                  ...
                                  int incy)
{
  cublasStatus_t sucess =
      cublasCcopy(handle, n, reinterpret_cast<cuComplex const*>(x), incx, reinterpret_cast<cuComplex*>(y), incy);
  cudaDeviceSynchronize();
  return sucess;
}
...
{
  cublasStatus_t sucess =
      cublasZcopy(handle, n, reinterpret_cast<cuDoubleComplex const*>(x), incx, reinterpret_cast<cuDoubleComplex*>(y), incy);
  cudaDeviceSynchronize();
  return sucess;
}
                                  ...
                                  int incy)
{
  ...
  if (Atrans == 'n' || Atrans == 'N')
    ...
    RUNTIME_CHECK(0, "Invalid Atrans argument.");
  cudaDeviceSynchronize();
  return sucess;
}
...
inline cublasStatus_t cublas_gemm(cublasHandle_t handle,
                                  ...
                                  int ldc)
{
  RUNTIME_CHECK(Atrans == 'n' || Atrans == 'N', "Invalid Atrans argument.");
  cublasStatus_t sucess =
...
inline cublasStatus_t cublas_gemmStridedBatched(cublasHandle_t handle,
                                                ...
                                                int batchSize)
{
  auto Af = reinterpret_cast<float const*>(A); 
  auto Cf = reinterpret_cast<float*>(C); 
  cublasStatus_t sucess =
      cublasSgemmStridedBatched(handle, cublasOperation(Atrans), cublasOperation(Btrans), 2*M, N, K, &alpha, Af, 2*lda,
                                2*strideA, B, ldb, strideB, &beta, Cf, 2*ldc, 2*strideC, batchSize);
  cudaDeviceSynchronize();
  return sucess;
}
...
inline cublasStatus_t cublas_gemmStridedBatched(cublasHandle_t handle,
                                                ...
                                                int batchSize)
{ 
  auto Ad = reinterpret_cast<double const*>(A); 
  auto Cd = reinterpret_cast<double*>(C); 
  cublasStatus_t sucess =
      cublasDgemmStridedBatched(handle, cublasOperation(Atrans), cublasOperation(Btrans), M, N, K, &alpha, Ad, 2*lda,                   
                                2*strideA, B, ldb, strideB, &beta, Cd, 2*ldc, 2*strideC, batchSize);
  cudaDeviceSynchronize();
  return sucess;
}

...
// Level-1
inline hipblasStatus_t hipblas_copy(hipblasHandle_t handle, int n, float const* x, int incx, float* y, int incy)
{
...
inline hipblasStatus_t hipblas_copy(hipblasHandle_t handle, int n, double const* x, int incx, double* y, int incy)
{
                                    ...
                                    int incy)
{
  hipblasStatus_t success =
      hipblasCcopy(handle, n, reinterpret_cast<hipblasComplex const*>(x), incx, reinterpret_cast<hipblasComplex*>(y), incy);
  hipDeviceSynchronize();
  return success;
}
...
inline hipblasStatus_t hipblas_copy(hipblasHandle_t handle,
                                    ...
                                    int incy)
{
  hipblasStatus_t success = hipblasZcopy(handle, n, reinterpret_cast<hipblasDoubleComplex const*>(x), incx,

...
#if defined(HAVE_MKL)
#include "Numerics/detail/CPU/mkl_spblas.h"
#endif
#include <cassert>
#include <complex>
...
void csrmv(const char transa,
           ...
           T* y)
{
  RUNTIME_CHECK(matdescra[0] == 'G' && (matdescra[3] == 'C' || matdescra[3] == 'F'), "");
...
inline static void csrmv(const char transa,
                         ...
                         std::complex<float>* y)
{
  RUNTIME_CHECK(matdescra[0] == 'G' && (matdescra[3] == 'C'), "");
  csrmm_impl(transa, M, 2, K, alpha, matdescra, A, indx, pntrb, pntre, reinterpret_cast<float const*>(x), 2, beta,
...
{
  RUNTIME_CHECK(matdescra[0] == 'G' && (matdescra[3] == 'C'), "");
  csrmm_impl(transa, M, 2, K, alpha, matdescra, A, indx, pntrb, pntre, reinterpret_cast<double const*>(x), 2, beta,
...
{
  RUNTIME_CHECK(matdescra[0] == 'G' && (matdescra[3] == 'C'), "");
  csrmm_impl(transa, M, 2 * N, K, alpha, matdescra, A, indx, pntrb, pntre, reinterpret_cast<double const*>(B), 2 * ldb, beta,
...
{
  RUNTIME_CHECK(matdescra[0] == 'G' && (matdescra[3] == 'C'), "");
  csrmm_impl(transa, M, 2 * N, K, alpha, matdescra, A, indx, pntrb, pntre, reinterpret_cast<float const*>(B), 2 * ldb, beta,

...
#ifndef MKL_SPARSE_BLAS_H
#define MKL_SPARSE_BLAS_H
...
extern "C"
{
  ...
  void mkl_dcsrmultd(const char* trans,
                     const MKL_INT* m,
                     const MKL_INT* n,
                     const MKL_INT* k,
                     double* a,
  ...
  void mkl_scsrmultd(const char* trans,
                     const MKL_INT* m,
                     const MKL_INT* n,
                     const MKL_INT* k,
                     float* a,
  ...
  void mkl_ccsrmultd(const char* trans,
                     const MKL_INT* m,
                     const MKL_INT* n,
                     const MKL_INT* k,
                     std::complex<float>* a,
  ...
  void mkl_zcsrmultd(const char* trans,
                     const MKL_INT* m,
                     const MKL_INT* n,
                     const MKL_INT* k,

...
//  constexpr
	...
	auto elements_at([[maybe_unused]] size_type n) const& -> element_cref {assert(n < this->num_elements()); return *(this->base_);}
	auto elements_at([[maybe_unused]] size_type n)     && -> element_ref  {assert(n < this->num_elements()); return *(this->base_);}
	auto elements_at([[maybe_unused]] size_type n)      & -> element_ref  {assert(n < this->num_elements()); return *(this->base_);}
